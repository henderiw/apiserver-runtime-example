...
// +k8s:conversion-gen=github.com/henderiw/apiserver-runtime-example/apis/config
// +k8s:defaulter-gen=TypeMeta
// +groupName=config.example.com

// Package v1alpha1 is the v1alpha1 version of the API.
package v1alpha1 // import "github.com/henderiw/apiserver-runtime-example/apis/config/v1alpha1"
